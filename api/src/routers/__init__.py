...
from src.routers.device_control_keys import router as device_control_keys_router
from src.routers.device_protocol import router as device_protocol_router
