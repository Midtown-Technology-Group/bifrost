...
export function ExecutionHistory() {
	...
	const filters = useMemo(() => {
		...
		return baseFilters;
	}, [statusFilter, dateRange, isPlatformAdmin, workflowIdFilter, showLocal]);
 ...
 if (input.workflowId) next.set("workflow", input.workflowId); else next.delete("workflow");
 return next;
 }, { replace: true });
		...
		[isPlatformAdmin, setStatusFilter, setSearchParams],
	);
