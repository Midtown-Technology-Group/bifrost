...
The September 25 Azure readback found **two B3 plan instances**. The September 24 inventory above is historical; do not use its single-instance shape or a 24-hour wall-clock window as the denominator for current B3-hours. The [cost correction](https://github.com/Midtown-Technology-Group/bifrost/pull/918) records the missing historical instance-hour evidence.
